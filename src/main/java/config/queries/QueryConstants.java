...
public class QueryConstants {
    ...
    public static final String QERY_ITEM_FROM_REPOSITORY_WHERE_ID_IS_GIVEN = "select item, store FROM Item item inner join item.store as store where item.id= :id";
