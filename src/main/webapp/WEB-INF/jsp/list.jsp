	...
	<h2><spring:message code="list.title"/></h2>
		<table>
			...
			<tr>
				...
				<c:if test="${item.available == true}"><td><input type="number" name="quantity" min="1" max="99" step="1"/></td><td><input type="button" value="<spring:message code="item.buy"/>"> </td></c:if>
